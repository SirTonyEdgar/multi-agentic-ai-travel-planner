      ...
      <div className="pesan-page">
        ...
        <div className="checkout-success fade-in-up">
          ...
          <div className="success-actions">
            <Button variant="primary" theme="sky" onClick={() => navigate('/')}>
              Kembali ke Beranda
            </Button>
            <Button variant="outline" theme="sky" onClick={() => navigate(`/plan?q=${encodeURIComponent(query)}`)}>
              Lihat Itinerary
            </Button>
          </div>
          <p className="success-footer-note text-caption text-light">
            Begini jika rencana ini disetujui. Redirect ke booking → e-commerce.
          </p>
        </div>
      </div>
    );
  ...
  return (
    <div className="pesan-page">
      ...
      <header className="pesan-navbar">
        <div className="pesan-navbar-inner">
          <Link
            to={`/pesan/hotel/${hotelId}?query=${encodeURIComponent(query)}`}
